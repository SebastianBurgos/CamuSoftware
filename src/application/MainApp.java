...
public class MainApp extends Application {
	...
	/**
	 * Metodo para obtener la lista de osportes asignados a un desarrollador
	 * segun su id
	 * 
	 * @param id_desarrollador
	 * @return
	...
	public void agregarImplementacionSoporteSeleccionado(int idSoporteSeleccionado, String especificacion,
			LocalDate fecha, int horas, String estado) {
		ImplementacionService.agregarImplementacionSoporteSeleccionado(idSoporteSeleccionado, especificacion, fecha,
				horas, estado);
	}
